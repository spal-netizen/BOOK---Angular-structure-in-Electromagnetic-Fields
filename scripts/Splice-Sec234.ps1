...
$fresh = Join-Path $root "latex\_sec234_fresh.tex"

$text = [System.IO.File]::ReadAllText($ch02)

$freshBody = [System.IO.File]::ReadAllText($fresh)

$startMarker = "\subsection{Inversion and solvability}"

$endMarker = "\section{Radiation Conditions and Uniqueness}"
...
Write-Host "sec234 replaced OK ($startBody..$endBody)"
